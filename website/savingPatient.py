...
def savePatient():
    ...
    new_patient = Patient(user_id=current_user.id, patientFirstName=patientFirstName, patientLastName=patientLastName,
                          gender=patientGender, patientNotes=patientNotes, patientCondition=patientCondition)
    return new_patient
